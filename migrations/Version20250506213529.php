 ...
 */
final class Version20250506213529 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE person ADD COLUMN generation INTEGER DEFAULT NULL
        SQL);
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TEMPORARY TABLE __temp__person AS SELECT id, father_id, mother_id, first_name, last_name, birth_date, death_date, birth_place, death_place, biography, photo FROM person
        SQL);
        $this->addSql(<<<'SQL'
            DROP TABLE person
        SQL);
        ...
        SQL);
        $this->addSql(<<<'SQL'
            INSERT INTO person (id, father_id, mother_id, first_name, last_name, birth_date, death_date, birth_place, death_place, biography, photo) SELECT id, father_id, mother_id, first_name, last_name, birth_date, death_date, birth_place, death_place, biography, photo FROM __temp__person
        SQL);
        $this->addSql(<<<'SQL'
